...
# flussonic.com/central-operator-bundle:$VERSION and flussonic.com/central-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= flussonic/central-operator
...
IMG ?= flussonic/central-controller:$(VERSION)
